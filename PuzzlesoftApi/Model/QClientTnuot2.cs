...
{
    public partial class QClientTnuot2
    {
        public int? ClientId { get; set; }
        public int? Idnum { get; set; }
        public DateTime? TntStamp { get; set; }
        ...
        public string LeaveKindDesc { get; set; }
        public int? TnuahMonth { get; set; }
        public string TnuahMonthEng { get; set; }
