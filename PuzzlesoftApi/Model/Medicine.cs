...
namespace PuzzlesoftApi.Model
{
    public partial class Medicine
    {
        ...
        public short LocalDolars { get; set; }
        ...
        public bool NarkotiDrug { get; set; }
        public bool? NotRecommended { get; set; }
        public string PackingSize { get; set; }
        public string DrugMemo { get; set; }
        public int? DrugGenericGroup { get; set; }
        public string KodMbr { get; set; }
        public int? TipulikodMbr { get; set; }
        public string TipulikodMbrDesc { get; set; }
        public double? AmountDose { get; set; }
        public int? AtcKodId { get; set; }
        public bool DangerDrug { get; set; }
        public bool SignMulti { get; set; }
        public bool? Vat { get; set; }
        public bool? OtcDrug { get; set; }
        public bool? DrugByNurse { get; set; }
        public string SeegnalCode { get; set; }
        public int MappingType { get; set; }
        public int? StatusCodeSeegnal { get; set; }
    }
}
